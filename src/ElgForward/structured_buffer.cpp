...
class StructuredBufferStorage {
 public:
   StructuredBufferStorage(size_t element_size, size_t element_align, size_t max_size)
...
ResourceArray<StructuredBufferHandle, StructuredBufferStorage, 255> g_storage_;
...
StructuredBufferHandle CreateStructuredBuffer(
  ...
  StructuredBufferStorage storage(type_size, type_alignment, max_size);
