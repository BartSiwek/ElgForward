...
struct VertexDataPoisition {
  ...
  static constexpr uint32_t InputLayoutElementCount = 1;
  static constexpr std::array<D3D11_INPUT_ELEMENT_DESC, InputLayoutElementCount> InputLayout = {
...
template<uint32_t InputSlot>
constexpr std::array<D3D11_INPUT_ELEMENT_DESC, VertexDataPoisition<InputSlot>::InputLayoutElementCount> VertexDataPoisition<InputSlot>::InputLayout;
...
struct VertexDataNormal {
  ...
  static constexpr uint32_t InputLayoutElementCount = 1;
  static constexpr D3D11_INPUT_ELEMENT_DESC InputLayout[InputLayoutElementCount] = {
...
template<uint32_t InputSlot>
constexpr D3D11_INPUT_ELEMENT_DESC VertexDataNormal<InputSlot>::InputLayout[VertexDataNormal<InputSlot>::InputLayoutElementCount];
...
template<uint32_t Index, uint32_t InputSlot>
constexpr D3D11_INPUT_ELEMENT_DESC VertexDataTexture<Index, InputSlot>::InputLayout[VertexDataTexture<Index, InputSlot>::InputLayoutElementCount];
